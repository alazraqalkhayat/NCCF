...
export default {
    ...
    methods: {
        ...
        store() {
            axios.post(route('detection.store'), {
        ...
        update() {
            axios.post(route('detection.update', { detection: this.editData.id }), {
        ...
        deleteFun() {
            axios.get(route('detection.delete', { detection: this.editData.id })).then(r => {
